 ...
 * Nenhum código deverá conter mensagens que vão diretamente ao usuário.
 *
 * @since 21/04/2012
 * @author Guilherme
 */
public final class I18N {
  ...
  /**
   * Retira o valor do arquivo: br.com.gbvbahia.solida.utils.I18n.properties, onde todas as
   * mensagens que são enviadas ao usuário ficam armazenadas.
   *
   * @param chave java.lang.String chave da mensagem que será enviada.
   * @return java.lang.String a ser utilizada para a chave passada, caso ocorra algum erro ou a
   *         chave não exista, será retornado o mesmo valor passado como parâmetro chave.
   */
  public static String getMsg(final String chave) {
    try {
      return ResourceBundle.getBundle("msg_make", Locale.getDefault(), I18N.class.getClassLoader())
          .getString(chave);
    } catch (Exception e) {
  ...
  /**
   * Retira o valor do arquivo: br.com.gbvbahia.solida.utils.I18n.properties, onde todas as
   * mensagens que são enviadas ao usuário ficam armazenadas. Este substitui todos {*} pela posição
   * correspondente no vararg.
   *
