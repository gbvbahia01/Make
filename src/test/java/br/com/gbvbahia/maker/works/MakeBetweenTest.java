...
public class MakeBetweenTest extends TestCase {
    ...
    public void testPopularBetween() throws Exception {
        ...
        for (int i = 0; i < 50; i++) {
            EntityBetweenTest test = MakeEntity.makeEntity("testBetween1",
                EntityBetweenTest.class, false);
            logger.debug(test);
