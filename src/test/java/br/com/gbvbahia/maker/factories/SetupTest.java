...
public class SetupTest {
  ...
  /**
   * Test for a file that not exists. At this case a XMLoaderException must be
   * launched.
   */
  ...
  @Test
  public void testMakeXmlEmpty() {
    Factory.loadSetup("empty_make.xml");
  ...
  @Test
  public void testMakeXmlEmptyTags() {
    Factory.loadSetup("empty_make_empty_tags.xml");
    Jsr303ReadSetupTest someFields = MakeEntity.make(Jsr303ReadSetupTest.class);
    Assert.assertTrue("No error was launched.", someFields != null);
  }

  @Test
  public void testMakeXmlReallyEmpty() {
    Factory.loadSetup("really_empty_make.xml");
    Jsr303ReadSetupTest someFields = MakeEntity.make(Jsr303ReadSetupTest.class);
    Assert.assertTrue("No error was launched.", someFields != null);
  }
  ...
  public void testDefaultValuesFactorySetupMakeXml() {
    Factory.loadSetup("make.xml");
    Assert.assertFalse("Make default does not ignore the JSR303",
        Factory.SETUP.ignoreJsr303());
    Assert.assertTrue("Make default reads the JSR303",
        Factory.SETUP.readJsr303());
    Jsr303ReadSetupTest nullFields = MakeEntity.make(Jsr303ReadSetupTest.class);
    Assert.assertNull("Default Integer must be null",
        nullFields.getDefaultInt());
    Assert.assertNull("Default Double must be null",
        nullFields.getDefaultDouble());
    Assert.assertNull("Default String must be null",
        nullFields.getDefaultString());
    Assert
    .assertNotNull(
    ...
    nullFields = MakeEntity
        .make(Jsr303ReadSetupTest.class, "testSetupKeyField");
    Assert.assertNull("Default Integer must be null",
        nullFields.getDefaultInt());
    Assert.assertNull("Default Double must be null",
        nullFields.getDefaultDouble());
  ...
  public void testFileMakeJsrReadNullSome() {
    ...
    Jsr303ReadSetupTest someFields = MakeEntity.make(Jsr303ReadSetupTest.class);
    Assert.assertNull("Default Integer must be null",
        someFields.getDefaultInt());
    Assert.assertNull("Default Double must be null",
        someFields.getDefaultDouble());
    Assert.assertNull("Default String must be null",
        someFields.getDefaultString());
    Assert.assertNotNull("Cannot be null because the annotation @NotNull.",
        someFields.getNotNullCharacter());

    someFields = MakeEntity
        .make(Jsr303ReadSetupTest.class, "testSetupKeyField");
    Assert.assertNotNull(
        "Cannot be null because the keyField is mapped as a keyfield in xml.",
    ...
    .assertTrue(
            ...
            (someFields.getNotKeyField() == null)
        || (someFields.getNotKeyField() != null));
  }
  ...
  public void testFileMakeJerReadNullAll() {
    ...
    Assert
    .assertNull("Default Integer must be null", allFields.getDefaultInt());
    Assert.assertNull("Default Double must be null",
        allFields.getDefaultDouble());
    Assert.assertNull("Default String must be null",
        allFields.getDefaultString());
  ...
  public void testFileMakeJsrIgnoreNullAll() {
    ...
    Assert.assertNull("Must be null because the test name was not informaded.",
        allFields.getKeyField());
    Assert.assertNull(
        "JSR303 must be ignored (@NotNull) and this field is not mapped.",
        allFields.getNotNullCharacter());
    Assert
    .assertNull(
            "Must be null because the null node is all and this field is not mapped.",
            allFields.getNotKeyField());
    ...
    Assert.assertNull("Default String must be null",
        allFields.getDefaultString());
    Assert.assertNotNull(
        "Cannot be null because the test name was informaded.",
        allFields.getKeyField());
    Assert.assertTrue(
        "keyField has no valid value: " + allFields.getKeyField(),
        (allFields.getKeyField() == 1.0) || (allFields.getKeyField() == 2.0)
  ...
  public void testFileMakeJsrIgnoreNullNever() {
    ...
    Jsr303ReadSetupTest neverFields = MakeEntity
        .make(Jsr303ReadSetupTest.class);
    Assert.assertNotNull("Default Integer cannot be null",
        neverFields.getDefaultInt());
    Assert.assertNotNull("Default Double cannot be null",
        neverFields.getDefaultDouble());
    Assert.assertNotNull("Default String cannot be null",
        neverFields.getDefaultString());
    Assert.assertNotNull(
        "keyField cannot be null because the test name was not informaded.",
        neverFields.getKeyField());
    Assert.assertNotNull("NotNullCharacter cannot be null.",
        neverFields.getNotNullCharacter());
    Assert.assertNotNull("NotKeyField cannot be null.",
        neverFields.getNotKeyField());
    neverFields = MakeEntity.make(Jsr303ReadSetupTest.class,
        "testSetupKeyField");
    Assert.assertNotNull("Default Integer cannot be null",
        neverFields.getDefaultInt());
    ...
    Assert.assertTrue(
        ...
        (neverFields.getKeyField() == 1.0)
            || (neverFields.getKeyField() == 2.0)
